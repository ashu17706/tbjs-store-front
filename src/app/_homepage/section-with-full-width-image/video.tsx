...
const Video = ({ url = "" }: { url: string }) => {
  ...
  return (
    ...
    >
      <div
        className={`absolute top-[50%] left-[50%] w-[65px] h-[65px] cursor-pointer translate-x-[-50%] translate-y-[-50%] border-[2px] border-[#E3FFB5] rounded-full z-10 hover:bg-black/20 flex justify-center items-center ${
