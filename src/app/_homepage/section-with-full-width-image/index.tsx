...
const SectionWithFullWidthImage = () => {
  return (
    <>
      <section className="md:block hidden md:px-[49px] md:mb-[150px]">
        <div className="md:h-[--height-viewport-without-header] md:mb-[49px]">
        ...
        <div className="h-[calc(var(--height-viewport-without-header)_*_2)] md:h-[--height-viewport-without-header] relative flex md:flex-row flex-col justify-between">
          ...
          <div className="h-full absolute top-0 bottom-0 right-[-545px] md:flex flex-col justify-center hidden">
